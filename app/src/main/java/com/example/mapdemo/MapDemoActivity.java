...
//                                BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN);
                        BitmapDescriptor customMarker =
                                BitmapDescriptorFactory.fromResource(R.drawable.icecreamcone2);
        ...
        map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener(){
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                BitmapDescriptor customMarker1 =
                        BitmapDescriptorFactory.fromResource(R.drawable.icecreamcone3);
                marker.setIcon(customMarker1);
                return true;
            }
        });
    }

    public void connectMarker(View v){
